    ...
    <div class="content">
        <div class="row">
            <div class="col-md-6 col-12 mx-auto">
                ...
                <hr/>
                <form:form method="post" action="/admin/update/shift" modelAttribute="newShift" onsubmit="displayPopup()">
                    <div class="form-group">
                        ...
                        <input type="text" path="newShift.employee_id" class="form-control" readonly="true"/>
